...
export const PLAYBOOK: Record<string, PlayDef> = {
  ...
  'play-std-3': {
    playId: 'play-std-3', name: 'Horns', side: 'offense', rarity: 'Common', allocation: 0.10,
  ...
  'play-std-4': {
    playId: 'play-std-4', name: 'Full Court Press', side: 'defense', rarity: 'Common', allocation: 0.10,
  ...
  'play-std-1': {
    playId: 'play-std-1', name: 'High Pick & Roll', side: 'offense', rarity: 'Uncommon', allocation: 0.13,
  ...
  'play-std-2': {
    playId: 'play-std-2', name: 'Box-and-One', side: 'defense', rarity: 'Uncommon', allocation: 0.13,
  ...
  'play-sys-4': {
    playId: 'play-sys-4', name: 'Motion Offense', side: 'offense', rarity: 'Rare', allocation: 0.15,
  ...
  'play-sys-3': {
    playId: 'play-sys-3', name: 'Grit and Grind', side: 'defense', rarity: 'Rare', allocation: 0.15,
  ...
  'play-std-5': {
    playId: 'play-std-5', name: 'Four Out One In', side: 'offense', rarity: 'Rare', allocation: 0.15,
  ...
  'play-sys-1': {
    playId: 'play-sys-1', name: 'Triangle Offense', side: 'offense', rarity: 'Mythic', allocation: 0.18,
  ...
  'play-sys-2': {
    playId: 'play-sys-2', name: '7 Seconds or Less', side: 'offense', rarity: 'Mythic', allocation: 0.18,
