...
const LEGENDARY_PLAYERS = new Set([
  ...
  "Kyrie Irving", "Kyle Lowry", "Mike Conley", "Paul George", 
  "Jimmy Butler", "DeMar DeRozan", "Klay Thompson", "Draymond Green", 
  "Gordon Hayward", "Anthony Davis", "Giannis Antetokounmpo", "Nikola Jokic", 
  "Joel Embiid", "Kevin Love", "Al Horford", "Nikola Vucevic", "Rudy Gobert",
...
export function getAllCards(): PlayerCard[] {
    ...
    for (const r of rawScores) {
      ...
      // LEGENDARY BUMP (Adds 1 tier, making drafting harder)
      if (isLegendary) {
