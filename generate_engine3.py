...
export function getAllCards(): PlayerCard[] {
    ...
    for (const r of rawScores) {
      ...
      let wFin = 0, wMid = 0, wPer = 0, wPlay = 0, wReb = 0, wPDef = 0, wIDef = 0;
      if (r.pool === "Guards") {
          wFin = 0.15; wMid = 0.15; wPer = 0.25; wPlay = 0.20; wReb = 0.05; wPDef = 0.15; wIDef = 0.05;
      } else if (r.pool === "Wings") {
          wFin = 0.20; wMid = 0.15; wPer = 0.20; wPlay = 0.10; wReb = 0.15; wPDef = 0.12; wIDef = 0.08;
      } else {
          wFin = 0.25; wMid = 0.10; wPer = 0.05; wPlay = 0.05; wReb = 0.30; wPDef = 0.05; wIDef = 0.20;
      }
      ...
      const activeWeights = [
          ...
          { key: 'pdef', val: perimeterDefense, weight: wPDef },
          { key: 'idef', val: postDefense, weight: wIDef }
      ];
      ...
      // 7th Skill (Index 6)
      const drain1 = Math.min(shift.bottom1, activeWeights[6].weight - shift.minFloor);
      activeWeights[6].weight -= drain1;
      totalDrained += drain1;
      
      // 6th Skill (Index 5)
      const drain2 = Math.min(shift.bottom2, activeWeights[5].weight - shift.minFloor);
      activeWeights[5].weight -= drain2;
      totalDrained += drain2;
