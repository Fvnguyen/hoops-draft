...
| 2c | [auth_approval](plans/plan_auth_approval_2026-09-13.md) — Supabase email/password auth, admin approval, and protected app routes | in progress | 2b | auth routes/components, Supabase migration/setup docs, auth tests, deployment docs | 2-3 days |
